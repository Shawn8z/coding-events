...
public class AuthenticationController {
    ...
    public String processRegisterationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        if (theUser == null) {
            errors.rejectValue("username", "user.invalid", "The given name do not exist");
            model.addAttribute("title", "Log In");
            return "login";
        }
